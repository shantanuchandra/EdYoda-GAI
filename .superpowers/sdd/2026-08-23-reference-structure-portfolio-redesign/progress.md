...
Task 12: in_progress — responsive browser RCA fixed: mobile navigation still asserted the old six-link reference count after the approved five-tab IA change; Chromium responsive suite now passes 5/5 at 320/390/768/1024/1440 with zero overflow.
Task 13: in_progress — updated the tabular original-build coverage audit with current route/course/portrait/microinteraction evidence; final Preview refresh remains after the clean release commit.
