...
export function WorkCard({ item }: WorkCardProps) {
  ...
  return (
    <Link className="group block text-inherit no-underline" href={`/work/${metadata.slug}`}>
      <article className="flex h-full min-h-[360px] flex-col rounded-card border border-line bg-surface p-[clamp(24px,4vw,36px)] transition-[border-color,box-shadow,translate] duration-200 ease-[var(--ease-out)] group-hover:-translate-y-1 group-hover:border-teal group-hover:shadow-[0_18px_48px_rgb(16_37_34_/_9%)] group-focus-visible:-translate-y-1 group-focus-visible:border-teal group-focus-visible:shadow-[0_18px_48px_rgb(16_37_34_/_9%)]">
