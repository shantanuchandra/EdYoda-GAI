...
type OutcomeListProps = {
  ariaLabel: string;
  outcomes: PublicContent["outcomes"];
};

export function OutcomeList({ ariaLabel, outcomes }: OutcomeListProps) {
  if (outcomes.length === 0) return null;

  return (
    <ul className="m-0 grid list-none gap-3 p-0 sm:grid-cols-2" aria-label={ariaLabel}>
